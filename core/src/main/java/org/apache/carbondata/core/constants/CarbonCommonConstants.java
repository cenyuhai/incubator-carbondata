...
public final class CarbonCommonConstants {
  ...
  /**
   * WHETHER TO BE COMPATIBLE WITH HIVE
   */
  public static final String HIVE_SCHEMA_COMPATIBILITY = "carbon.hive.schema.compatibility.enable";

  /**
   * default is false
   */
  public static final String DEFAULT_HIVE_SCHEMA_COMPATIBILITY = "false";
